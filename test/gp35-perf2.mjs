...
new Function('ctx', 'harness', 'console', 'btoa', 'atob', 'TextEncoder', 'TextDecoder', body)(ctx, { handle(n, f) { handlers.set(n, f); return () => {} }, defineTool: d => d, registerTool: () => () => {} }, console, s => s, s => s, TextEncoder, TextDecoder).apply(ctx)
